...
curl -d "type=update&account_email=$account_email&instance_name=$instance_name&ip_address=$ip_address&current_profile=$current_profile" -X POST "https://air.xinstores.com/openvpn/api.php"